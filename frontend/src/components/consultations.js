// src/components/consultations.js
...
function Consultations({ logOut }) {
  ...
  <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={ko}>
          ...
          <Grid container spacing={2} justifyContent="center">
            <Grid item xs={6}>
              ...
              <RadioGroup
                ...
                onChange={(e) => setPaymentIntention(e.target.value)}
              >
                <FormControlLabel value="ALL" control={<Radio />} label="ALL" />
                <FormControlLabel value="Y" control={<Radio />} label="Y" />
                <FormControlLabel value="N" control={<Radio />} label="N" />
            ...
            <Grid item xs={6}>
              ...
              <RadioGroup
                row
                value={illegalCollection}
                onChange={(e) => setIllegalCollection(e.target.value)}
              >
                <FormControlLabel value="ALL" control={<Radio />} label="ALL" />
                <FormControlLabel value="Y" control={<Radio />} label="Y" />
                <FormControlLabel value="N" control={<Radio />} label="N" />
      ...
      <Box mt={2} sx={{ height: 400, width: "100%" }}>
        <DataGrid rows={dummyData} columns={columns} disableRowSelectionOnClick />
      </Box>
